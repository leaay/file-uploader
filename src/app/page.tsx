...
export default  function Home() {
  ...
  return (
    ...
    <div className="bg-white ">
      ...
      {/* 1  */}
      <div className="relative isolate px-8  overflow-hidden flex ">

        <div className="left-0 absolute py-4 px-8 md:py-8  w-full w-max-[1200px]   flex justify-between">
          <Link href={'/'} className="font-medium  md:text-2xl flex  items-center  gap-x-2"><Image src="/logo.svg" width={44} height={44} alt="logo"/><h1 className="text-[1rem] font-medium tracking-wide">Uploaderv1</h1></Link>
          {user ? 
          <UserButton  /> :
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#9333ea] to-[#5c00b0] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          />
        </div>

        <div className="mx-auto max-w-2xl flex justify-center items-center h-screen">

          <div className="text-center">
            <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
            Effortless file storage and sharing for everyone
            </h1>
            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
            Securely upload, store, and access your files from anywhere. With advanced encryption and seamless sharing options, your data is always safe and accessible.
            </p>
          ...
          <div
            aria-hidden="true"
            className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)] none"
          >
            <div
              style={{
                clipPath:
...
.catch(error => console.error("Error:", error));`}
      ...
      <div className="mx-auto max-w-7xl py-32 ">
        <div className="relative isolate overflow-hidden bg-gray-900  shadow-2xl rounded-3xl  lg:flex lg:gap-x-20  p-8 md:p-16 mx-8">
          <svg
          ...
          <div className="relative hidden md:block">
            <Image
              ...
              width={900}
              height={555}
              className="absolute left-[-40%] top-[-20%] w-[57rem] max-w-none "
            />
          </div>
        </div>
      </div>
